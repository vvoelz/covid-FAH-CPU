...
usage = """
    Usage:   continue_a_tpr_NOREST.py [prev-tprfile] [prev-jobdir] [this-jobdir] [topfile] [ndxfile] [ps to extend] [output tprfile]

EXAMPLE

    $ python continue_a_tpr_NOREST.py testout/frame0.tpr testout nextout RUN0/topol.top  RUN0/index.ndx 1000  nextout/frame1.tpr
"""
...
e = expanded_ensemble_mdpfile_NOREST(init_lambda_weights=wang_landau_weights,
